...
ALLOWED_HOSTS = [h.strip() for h in os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,bigdeals-django.onrender.com').split(',')]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'BigSite' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
SUPABASE_URL = os.getenv('SUPABASE_POOLER_URL')
